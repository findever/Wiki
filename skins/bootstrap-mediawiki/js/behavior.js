$(function() {
	...
	if ( $('.toc-sidebar').length > 0 ) {
		...
		$('#toc').each(function() {
			...
			$('.page-header').prepend('<ul class="nav nav-pills pull-right"><li class="dropdown" id="page-contents"><a class="dropdown-toggle" data-toggle="dropdown"><i class="icon-list"></i> 目录 <span class="caret"></span></a> <ul class="dropdown-menu"></ul></li></ul>');
